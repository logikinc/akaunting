...
(function(L, a) {
  ...
  (function(a) {
    ...
    a.Fx.prototype = {
      dSetter: function() {
        ...
        if (1 === u) f = this.toD;
          ...
          for (; l--; )
            (q = parseFloat(a[l])),
              (f[l] = isNaN(q) ? a[l] : u * parseFloat(g[l] - q) + q);
        else f = g;
      ...
      update: function() {
        ...
        if (this[g + "Setter"]) this[g + "Setter"]();
          ...
          a.attr
            ? a.element && a.attr(g, f, null, !0)
            : (a.style[g] = f + this.unit);
        u && u.call(a, f, this);
      },
      run: function(a, g, f) {
        var r = this,
      ...
      step: function(a) {
        ...
        if (f.attr && !f.element) f = !1;
          ...
          (this.pos = u.easing((r - this.startTime) / q)),
      ...
      initPath: function(r, g, f) {
        ...
        function q(a, e) {
          for (var b = (m - a.length) / t; 0 < b && b--; )
            (c = a.slice().splice(a.length / z - t, t * z)),
              (c[0] = e[m - t - b * t]),
              C && ((c[t - 6] = c[t - 2]), (c[t - 5] = c[t - 1])),
              [].splice.apply(a, [a.length / z, 0].concat(c)),
              E && b--;
        }
        g = g || "";
        var d,
    ...
    a.attr = function(r, g, f) {
      ...
      if (a.isString(g))
        a.defined(f)
          ? r.setAttribute(g, f)
          : r && r.getAttribute && (l = r.getAttribute(g));
    ...
    a.getTZOffset = function(r) {
      ...
      return (
        6e4 *
        ((g.hcGetTimezoneOffset && g.hcGetTimezoneOffset(r)) ||
          g.hcTimezoneOffset ||
          0)
      );
    };
    ...
    a.addEvent = function(r, g, f) {
      ...
      r.addEventListener
        ? r.addEventListener(g, f, !1)
        : r.attachEvent &&
          (r.hcEventsIE || (r.hcEventsIE = {}),
          (r.hcEventsIE[f.toString()] = u),
          r.attachEvent("on" + g, u));
      l[g] || (l[g] = []);
      l[g].push(f);
      return function() {
        a.removeEvent(r, g, f);
    ...
    a.removeEvent = function(r, g, f) {
      function u(a, b) {
        r.removeEventListener
          ? r.removeEventListener(a, b, !1)
          : r.attachEvent &&
            ((b = r.hcEventsIE[b.toString()]), r.detachEvent("on" + a, b));
      }

      function l() {
        var a, b;
        if (r.nodeName)
          for (b in (g ? ((a = {}), (a[g] = !0)) : (a = d), a))
            if (d[b]) for (a = d[b].length; a--; ) u(b, d[b][a]);
      }
      var q,
        d = r.hcEvents,
        b;
    ...
    a.fireEvent = function(r, g, f, u) {
      ...
      if (H.createEvent && (r.dispatchEvent || r.fireEvent))
        (l = H.createEvent("Events")),
          l.initEvent(g, !0, !0),
          a.extend(l, f),
          r.dispatchEvent ? r.dispatchEvent(l) : r.fireEvent(g, l);
      else if (l)
        for (
          l = l[g] || [],
            q = l.length,
    ...
    a.animate = function(r, g, f) {
      ...
      for (b in g)
        a.stop(r, b),
          ...
          (q = null),
          "d" === b
            ? ((d.paths = d.initPath(r, r.d, g.d)),
              (d.toD = g.d),
              (u = 0),
              (q = 1))
            : r.attr
              ? (u = r.attr(b))
              : ((u = parseFloat(a.getStyle(r, b)) || 0),
                "opacity" !== b && (l = "px")),
          q || (q = g[b]),
    ...
    H &&
      ...
      (a.getStyle = function(r, g) {
        ...
        if (f)
          return (
            (r.style.zoom = 1), Math.max(r[f] - 2 * a.getStyle(r, "padding"), 0)
          );
        r =
          r.currentStyle[
            g.replace(/\-(\w)/g, function(a, l) {
              return l.toUpperCase();
            })
          ];
        "filter" === g &&
          (r = r.replace(/alpha\(opacity=([0-9]+)\)/, function(a, l) {
            return l / 100;
          }));
        return "" === r ? 1 : a.pInt(r);
      });
  ...
  (function(a) {
    ...
    a.Color.prototype = {
      ...
      init: function(g) {
        var f, u, l, q;
        if ((this.input = g = this.names[g] || g) && g.stops)
          this.stops = H(g.stops, function(d) {
            return new a.Color(d[1]);
          });
        else
          for (l = this.parsers.length; l-- && !u; )
  ...
  (function(a) {
    ...
    B.prototype = {
      ...
      colorGradient: function(v, k, e) {
        ...
        v.linearGradient
          ? (D = "linearGradient")
          : v.radialGradient && (D = "radialGradient");
        if (D) {
          c = v[D];
          M = b.gradients;
          n = v.stops;
          ...
          M[w]
            ...
            : ((c.id = t = a.uniqueKey()),
              ...
              C(n, function(v) {
                0 === v[1].indexOf("rgba")
                  ? ((h = a.color(v[1])), (d = h.get("rgb")), (F = h.get("a")))
                  : ((d = v[1]), (F = 1));
                v = b
                  .createElement("stop")
                  .attr({
      ...
      applyTextOutline: function(a) {
        ...
        -1 !== a.indexOf("contrast") &&
          (a = a.replace(/contrast/g, this.renderer.getContrast(v.style.fill)));
        this.fakeTS = !0;
        ...
        (b = a[0]) &&
          "none" !== b &&
          ((b = b.replace(/(^[\d\.]+)(.*?)$/g, function(a, v, k) {
            return 2 * v + k;
          })),
          C(k, function(a) {
      ...
      attr: function(a, k, e, b) {
        ...
        "string" === typeof a &&
          ...
          ((v = a), (a = {}), (a[v] = k));
        if ("string" === typeof a)
          x = (this[a + "Getter"] || this._defaultGetter).call(this, a, c);
        else {
          for (v in a)
            (k = a[v]),
              (M = !1),
              ...
              !this.rotation ||
                ...
                (this.doTransform = !0),
              M ||
                ((M = this[v + "Setter"] || this._defaultSetter),
                M.call(this, k, v, c),
                this.shadows &&
                  /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(
                    v
                  ) &&
                  this.updateShadows(v, k, M));
      ...
      align: function(a, k, e) {
        ...
        if (a) {
          if (
            ((this.alignOptions = a), (this.alignByTranslate = k), !e || w(e))
          )
      ...
      getBBox: function(a, k) {
        ...
        if (!v) {
          if (c.namespaceURI === this.SVG_NS || e.forExport) {
            try {
              (m =
                this.fakeTS &&
                function(a) {
                  C(c.querySelectorAll(".highcharts-text-outline"), function(
                    v
                  ) {
                    v.style.display = a;
                  });
          ...
          e.isSVG &&
            ...
            k &&
              ((v.width =
                Math.abs(e * Math.sin(b)) + Math.abs(a * Math.cos(b))),
              (v.height =
                Math.abs(e * Math.cos(b)) + Math.abs(a * Math.sin(b)))));
          if (F && 0 < v.height) {
        ...
        if (!a) this.destroyShadows();
          ...
          for (b = 1; b <= x; b++)
            (c = h.cloneNode(0)),
              ...
              e &&
                (r(c, "height", Math.max(r(c, "height") - D, 0)),
                (c.cutHeight = D)),
              k ? k.element.appendChild(c) : h.parentNode.insertBefore(c, h),
              v.push(c);
          this.shadows = v;
        }
        return this;
      ...
      titleSetter: function(a) {
        ...
        v ||
          ((v = p.createElementNS(this.SVG_NS, "title")),
          this.element.appendChild(v));
        v.firstChild && v.removeChild(v.firstChild);
        v.appendChild(
          p.createTextNode(String(K(a), "").replace(/<[^>]*>/g, ""))
        );
      },
      ...
      zIndexSetter: function(a, k) {
        ...
        var x;
        q(a) &&
          ((h.zIndex = a), (a = +a), this[k] === a && (c = !1), (this[k] = a));
        if (c) {
    ...
    B.prototype.translateXSetter = B.prototype.translateYSetter = B.prototype.rotationSetter = B.prototype.verticalAlignSetter = B.prototype.scaleXSetter = B.prototype.scaleYSetter = function(
      a,
      k
    ) {
      this[k] = a;
    ...
    B.prototype["stroke-widthSetter"] = B.prototype.strokeSetter = function(
      a,
      k,
      e
    ) {
      ...
      this.stroke && this["stroke-width"]
        ? (B.prototype.fillSetter.call(this, this.stroke, "stroke", e),
    ...
    A.prototype = {
      ...
      init: function(a, k, b, c, D, x) {
        ...
        this.alignedObjects = [];
        this.url =
          (e || h) && p.getElementsByTagName("base").length
            ? O.location.href
                .replace(/#.*?$/, "")
                .replace(/<[^>]*>/g, "")
                .replace(/([\('\)])/g, "\\$1")
        ...
        this.createElement("desc")
          .add()
          .element.appendChild(
            p.createTextNode("Created with Highcharts 5.0.7")
          );
        ...
        e &&
          ...
          k(),
          (this.unSubPixelFix = H(O, "resize", k)));
      },
      getStyle: function(a) {
        return (this.style = t(
          {
      ...
      buildText: function(a) {
        var k = a.element,
          ...
          J = function(a) {
            var e;
            e = /(px|em)$/.test(a && a.style.fontSize)
              ? a.style.fontSize
              : E || v.style.fontSize || 12;
            return w
              ? I(w)
              : v.fontMetrics(e, a.getAttribute("style") ? a : k).h;
          };
      ...
      image: function(a, k, e, b, c) {
        ...
        v.element.setAttributeNS
          ? v.element.setAttributeNS("http://www.w3.org/1999/xlink", "href", a)
      ...
      symbol: function(a, k, e, b, c, h) {
        var v = this,
          ...
          x = this.symbols[a],
          m =
            q(k) && x && this.symbols[a](Math.round(k), Math.round(e), b, c, h),
          y = /^url\((.*?)\)$/,
          d,
          n;
        x
          ...
          : y.test(a) &&
            ((d = a.match(y)[1]),
            (D = this.image(d)),
            (D.imgwidth = K(S[d] && S[d].width, h && h.width)),
            (D.imgheight = K(S[d] && S[d].height, h && h.height)),
            (n = function() {
              D.attr({
                width: D.width,
                height: D.height
            ...
            C(["width", "height"], function(a) {
              D[a + "Setter"] = function(a, k) {
                ...
                this[k] = a;
                q(b) &&
                  (this.element && this.element.setAttribute(k, b),
                  this.alignByTranslate ||
                    ((e[v] = ((this[k] || 0) - b) / 2), this.attr(e)));
              };
            }),
            q(k) &&
              D.attr({
      ...
      symbols: {
        ...
        callout: function(a, k, e, b, c) {
          ...
          v && v > e
            ...
            : v && 0 > v
              ? c > k + D && c < k + b - D
                ? x.splice(33, 3, "L", a, c + 6, a - 6, c, a, c - 6, a, k + h)
              ...
              : c && c > b && v > a + D && v < a + e - D
                ...
                : c &&
                  ...
                  v > a + D &&
                  v < a + e - D &&
                  x.splice(3, 3, "L", v - 6, k, v, k - 6, v + 6, k, e - h, k);
          return x;
        }
      },
      ...
      fontMetrics: function(a, k) {
        ...
        a = /px/.test(a)
          ? I(a)
          : /em/.test(a)
            ? parseFloat(a) * (k ? this.fontMetrics(null, k.parentNode).f : 16)
            : 12;
        ...
        Q = function() {
          ...
          M &&
            (w ||
              ...
              (k.x = a),
              (k.y = (m ? -u : 0) + a)),
            (k.width = Math.round(n.width)),
            (k.height = Math.round(n.height)),
            w.attr(t(k, N)),
            (N = {}));
        };
        R = function() {
          ...
          q(f) &&
            ...
            (a +=
              ...
              (f - p.width));
          if (a !== F.x || k !== F.y)
            F.attr("x", a), void 0 !== k && F.attr("y", k);
          F.x = a;
          F.y = k;
        };
        O = function(a, k) {
  ...
  (function(a) {
    ...
    g(a.SVGElement.prototype, {
        ...
        if (this.added) {
          ...
          if ("SPAN" === b.tagName) {
            ...
            y !== this.cTT &&
              ...
              G(F) && this.setSpanRotation(F, e, x),
              H(b, {
                width: "",
                whiteSpace: h || "nowrap"
              }),
      ...
      setSpanRotation: function(a, d, m) {
        ...
        c[n + (f ? "Origin" : "-origin")] = c.transformOrigin =
          100 * d + "% " + m + "px";
        H(this.element, c);
      },
    ...
    a.svg ||
      ((A = {
        ...
        init: function(a, b) {
          ...
          b &&
            ((e = h || "span" === b || "img" === b ? e.join("") : a.prepVML(e)),
            (this.element = H(e)));
          this.renderer = a;
        },
        add: function(a) {
              ...
              : "Z" === a[b]
                ...
                : ((e[b] = a[b]),
                  !a.isArc ||
                    ("wa" !== a[b] && "at" !== a[b]) ||
                    (e[b + 5] === e[b + 7] &&
                      (e[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1),
                    e[b + 6] === e[b + 8] &&
                      (e[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1)));
          return e.join(" ") || "x";
        },
        clip: function(a) {
          var b = this,
        ...
        shadow: function(a, b, n) {
          ...
          if (a) {
            ...
            for (h = 1; 3 >= h; h++)
              (l = 2 * z + 1 - 2 * h),
                n && (t = this.cutOffPath(D.value, l + 0.5)),
                (k = [
                ...
                H(x.prepVML(k), null, null, p),
                b ? b.element.appendChild(p) : d.parentNode.insertBefore(p, d),
                e.push(p);
            this.shadows = e;
          }
          return this;
        ...
        dashstyleSetter: function(a, b, c) {
          (c.getElementsByTagName("stroke")[0] ||
            H(this.renderer.prepVML(["\x3cstroke/\x3e"]), null, null, c))[b] =
            a || "solid";
          this[b] = a;
        },
      ...
      (a.VMLElement = A = B(n, A)),
      (A.prototype.ySetter = A.prototype.widthSetter = A.prototype.heightSetter =
        A.prototype.xSetter),
      (A = {
        Element: A,
        ...
        init: function(a, b, c) {
          ...
          if (!u.namespaces.hcv) {
            ...
            try {
              u.createStyleSheet().cssText =
                "hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } ";
            } catch (y) {
              u.styleSheets[0].cssText +=
                "hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } ";
            }
          }
        },
        ...
        color: function(b, c, n, m) {
          ...
          if (t) {
            ...
            var C,
              ...
              r = function() {
                p = [
                  '\x3cfill colors\x3d"' + u.join(",") + '" opacity\x3d"',
                  v,
                  '" o:opacity2\x3d"',
                  E,
                  '" type\x3d"',
            ...
            l(b, function(k, b) {
              x.test(k[1])
                ? ((d = a.color(k[1])), (D = d.get("rgb")), (w = d.get("a")))
                : ((D = k[1]), (w = 1));
              u.push(100 * k[0] + "% " + D);
              b ? ((v = w), (q = D)) : ((E = w), (g = D));
            });
            if ("fill" === n)
              if ("gradient" === t)
                (n = z.x1 || z[0] || 0),
                  ...
                  (F =
                    'angle\x3d"' +
                    (90 - (180 * Math.atan((z - b) / (f - n))) / Math.PI) +
                    '"'),
                  r();
              else {
                var k = z.r,
            ...
            x.test(b) && "IMG" !== c.tagName
              ? ((d = a.color(b)),
                m[n + "-opacitySetter"](d.get("a"), n, c),
                (k = d.get("rgb")))
              : ((k = c.getElementsByTagName(n)),
        ...
        createElement: function(a) {
          return "rect" === a
            ? this.symbol(a)
            : E.prototype.createElement.call(this, a);
        },
        ...
        symbols: {
          ...
          rect: function(a, b, c, n, h) {
            return E.prototype.symbols[r(h) && h.r ? "callout" : "square"].call(
              0,
              a,
              b,
              c,
  ...
  (function(a) {
    ...
    function A() {
      ...
      q.hcMakeTime = function(a, b, m, c, n, p) {
        var l;
        d
          ? ((l = q.UTC.apply(0, arguments)), (l += r(l)))
          : (l = new q(a, b, f(m, 1), f(c, 0), f(n, 0), f(p, 0)).getTime());
        return l;
      };
    ...
    a.defaultOptions = {
      ...
      global: {
        ...
        VMLRadialGradientURL:
          "http://code.highcharts.com/5.0.7/gfx/vml-radial-gradient.png"
      },
      chart: {
        borderRadius: 0,
    ...
    a.PlotLineOrBand.prototype = {
      render: function() {
        var a = this,
          ...
          x = {
            class:
              "highcharts-plot-" + (n ? "band " : "line ") + (b.className || "")
          },
          J = {},
          K = q.chart.renderer,
          I = n ? "bands" : "lines",
  ...
  (function(a) {
    ...
    a.Tick.prototype = {
      addLabel: function() {
        ...
        a.isDatetimeAxis &&
          t &&
          (n = f.dateTimeLabelFormats[t.higherRanks[p] || t.unitName]);
        this.isFirst = m;
        this.isLast = c;
      ...
      handleOverflow: function(a) {
        ...
        if (t)
          0 > t && q - m * c < p
            ? (e = Math.round(q / Math.cos(t * f) - p))
            : 0 < t &&
              q + m * c > b &&
              (e = Math.round((d - q) / Math.cos(t * f)));
        else if (
          ((d = q + (1 - m) * c),
          q - m * c < p
            ? (E = a.x + E * (1 - m) - p)
          ...
          E < n &&
            "center" === l.labelAlign &&
            (a.x += z * (n - E - m * (n - Math.min(c, E)))),
          c > E || (l.autoRotation && (C.styles || {}).width))
        )
          e = E;
        e &&
          ((x.width = e),
      ...
      getPosition: function(a, f, g, d) {
        ...
        return {
          x: a
            ? b.translate(f + g, null, null, d) + b.transB
            : b.left +
              b.offset +
              (b.opposite
                ? ((d && p.oldChartWidth) || p.chartWidth) - b.right - b.left
                : 0),
          y: a
            ? l - b.bottom + b.offset - (b.opposite ? b.height : 0)
            : l - b.translate(f + g, null, null, d) - b.transB
        };
      },
        ...
        A(e) ||
          (e =
            0 === m.side
              ...
              : 2 === m.side
                ? z.y + 8
                : Math.cos(q.rotation * f) *
                  (z.y - q.getBBox(!1, 0).height / 2));
      ...
      render: function(a, f, q) {
        ...
        if (
          !f &&
          E &&
          (c = d.getPlotLinePath(c + J, E.strokeWidth() * k, f, !0))
        )
        ...
        m &&
          G(I) &&
          ((m.xy = K = this.getLabelPosition(I, K, m, l, n, J, a, w)),
          (this.isFirst && !this.isLast && !g(b.showFirstLabel, 1)) ||
          (this.isLast && !this.isFirst && !g(b.showLastLabel, 1))
            ? (y = !1)
            : !l ||
              d.isRadial ||
              n.step ||
              ...
              f ||
              0 === q ||
              this.handleOverflow(K),
          w && a % w && (y = !1),
          y && G(K.y)
            ? ((K.opacity = q), m[this.isNew ? "attr" : "animate"](K))
            : m.attr("y", -9999),
          (this.isNew = !1));
      },
      destroy: function() {
  ...
  (function(a) {
    ...
    a.Axis.prototype = {
      ...
      init: function(a, b) {
        ...
        this.crosshair = w(
          c.crosshair,
          J(a.options.tooltip.crosshairs)[k ? 0 : 1],
          !1
        );
        var h;
        b = this.options.events;
        -1 === n(this, a.axes) &&
          (k ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this),
        ...
        b(a.series, function(b) {
          if (b.visible || !e.options.chart.ignoreHiddenSeries) {
            ...
            if (a.isXAxis)
              (k = b.xData),
                k.length &&
                  ...
                  z(b) ||
                    ...
                    (b = G(k))),
                  (a.dataMin = Math.min(w(a.dataMin, k[0]), b)),
                  (a.dataMax = Math.max(w(a.dataMax, k[0]), H(k))));
            else if (
              (b.getExtremes(),
              (D = b.dataMax),
              (b = b.dataMin),
              l(b) &&
                l(D) &&
                ((a.dataMin = Math.min(w(a.dataMin, b), b)),
                (a.dataMax = Math.max(w(a.dataMax, D), D))),
              l(h) && (a.threshold = h),
              !k.softThreshold || a.isLog)
            )
              a.softThreshold = !1;
          }
        });
      ...
      getPlotLinePath: function(a, b, c, e, h) {
        ...
        z(h)
          ? this.horiz
            ? ((m = n),
              (d = f - this.bottom),
              (a = c = t(a, D, D + this.width)))
            : ((a = D),
              (c = p - this.right),
              (m = d = t(m, n, n + this.height)))
          : (y = !0);
        return y && !e
          ? null
          : k.renderer.crispLine(["M", a, m, "L", c, d], b || 1);
      },
      ...
      adjustForMinRange: function() {
        ...
        e - c < this.minRange &&
          ...
          (h = (y - e + c) / 2),
          (h = [c - h, w(a.min, c - h)]),
          n && (h[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin),
          (c = H(h)),
          (e = [c + y, w(a.max, c + y)]),
          n && (e[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax),
          (e = G(e)),
          e - c < y && ((h[0] = e - y), (h[1] = w(a.min, e - y)), (c = H(h))));
        this.min = c;
        this.max = e;
      },
      getClosest: function() {
      ...
      setAxisTranslation: function(a) {
        ...
        if (t || y || h)
          (n = k.getClosest()),
            f
              ? ((m = f.minPointOffset), (d = f.pointRangePadding))
              : b(k.series, function(a) {
                  var b = y
                    ? 1
                    : t
                      ? w(a.options.pointRange, n, 0)
                      : k.axisPointRange || 0;
                  a = a.options.pointPlacement;
                  h = Math.max(h, b);
                  k.single ||
                    ((m = Math.max(m, e(a) ? 0 : b / 2)),
                    (d = Math.max(d, "on" === a ? 0 : b)));
                }),
            (f = k.ordinalSlope && n ? k.ordinalSlope / n : 1),
            (k.minPointOffset = m *= f),
            (k.pointRangePadding = d *= f),
            (k.pointRange = Math.min(h, c)),
            t && (k.closestPointRange = n);
        a && (k.oldTransA = p);
      ...
      setTickInterval: function(k) {
        ...
        A = w(c.userMax, h.max);
        p
          ? ((c.linkedParent = e[c.coll][h.linkedTo]),
            (e = c.linkedParent.getExtremes()),
            (c.min = w(e.min, e.dataMin)),
            (c.max = w(e.max, e.dataMax)),
            h.type !== c.linkedParent.options.type && a.error(11, 1))
          : (!K &&
              l(J) &&
              (c.dataMin >= J
                ? ((I = J), (x = 0))
                : c.dataMax <= J && ((r = J), (t = 0))),
            (c.min = w(u, I, c.dataMin)),
            (c.max = w(A, r, c.dataMax)));
        n &&
          (!k && 0 >= Math.min(c.min, w(c.dataMin, c.min)) && a.error(10, 1),
          (c.min = f(d(c.min), 15)),
          (c.max = f(d(c.max), 15)));
        c.range &&
          l(c.max) &&
        ...
        c.adjustForMinRange();
        !(q || c.axisPointRange || c.usePercentage || p) &&
          l(c.min) &&
          l(c.max) &&
          (d = c.max - c.min) &&
          (!l(u) && x && (c.min -= d * x), !l(A) && t && (c.max += d * t));
        z(h.floor)
          ? (c.min = Math.max(c.min, h.floor))
          : z(h.softMin) && (c.min = Math.min(c.min, h.softMin));
        z(h.ceiling)
          ? (c.max = Math.min(c.max, h.ceiling))
          : z(h.softMax) && (c.max = Math.max(c.max, h.softMax));
        K &&
          l(c.dataMin) &&
          ((J = J || 0),
          !l(u) && c.min < J && c.dataMin >= J
            ? (c.min = J)
            : !l(A) && c.max > J && c.dataMax <= J && (c.max = J));
        c.tickInterval =
          c.min === c.max || void 0 === c.min || void 0 === c.max
            ? 1
            : p && !g && E === c.linkedParent.options.tickPixelInterval
              ? (g = c.linkedParent.tickInterval)
              : w(
                  g,
                  this.tickAmount
                    ? (c.max - c.min) / Math.max(this.tickAmount - 1, 1)
                    : void 0,
                  q ? 1 : ((c.max - c.min) * E) / Math.max(c.len, E)
                );
        y &&
          !k &&
      ...
      setAxisSize: function() {
        ...
        c.test(m) &&
          (m = Math.round((parseFloat(m) / 100) * a.plotHeight + a.plotTop));
        this.left = b;
        this.top = m;
        this.width = h;
        this.height = n;
      ...
      unsquish: function() {
        var a = this.options.labels,
          ...
          h = e,
          n =
            this.len / (((this.categories ? 1 : 0) + this.max - this.min) / e),
          m,
          d = a.rotation,
          f = this.labelMetrics(),
          p,
        ...
        c
          ? (t =
              ...
              (l(d)
                ? [d]
                : n < w(a.autoRotationLimit, 80) && a.autoRotation)) &&
            b(t, function(a) {
              var b;
              if (a === d || (a && -90 <= a && 90 >= a))
                (p = x(Math.abs(f.h / Math.sin(q * a)))),
                  (b = p + Math.abs(a / 360)),
                  b < y && ((y = b), (m = a), (h = p));
            })
          : a.step || (h = x(f.h));
      ...
      renderUnsquish: function() {
          ...
          for (g.textOverflow = "clip", E = h.length; !d && E--; )
            if (((w = h[E]), (f = n[w].label)))
              f.styles && "ellipsis" === f.styles.textOverflow
                ...
                f.getBBox().height > this.len / h.length - (y.h - y.f) &&
                  (f.specCss = {
        ...
        p.rotation &&
          ((g = {
            width:
              (z > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : a.chartHeight) +
              "px"
          }),
      ...
      getOffset: function() {
        ...
        a.axisGroup ||
          ((a.gridGroup = e
            ...
            .addClass(
              "highcharts-" + this.coll.toLowerCase() + "-grid " + (I || "")
            )
            .add(r)),
          (a.axisGroup = e
            .g("axis")
            ...
            .addClass("highcharts-" + this.coll.toLowerCase() + " " + (I || ""))
            .add(r)),
          (a.labelGroup = e
            .g("axis-labels")
            .attr({
            ...
            .addClass(
              "highcharts-" + a.coll.toLowerCase() + "-labels " + (I || "")
            )
            .add(r)));
        if (y || a.isLinked)
          b(n, function(b, c) {
            ...
            a.staggerLines &&
              ((F *= a.staggerLines),
              (a.labelOffset = F * (a.opposite ? -1 : 1)));
        ...
        E &&
          ...
          (a.addTitle(t),
          t &&
            ((x = a.axisTitle.getBBox()[d ? "height" : "width"]),
            (g = E.offset),
            (z = l(g) ? 0 : w(E.margin, d ? 5 : 10))));
        a.renderLine();
        ...
        J[f] = Math.max(
          J[f],
          a.axisTitleMargin + x + K * a.offset,
          z,
          y && n.length && u ? u[0] : 0
        );
      ...
      getTitlePosition: function() {
        var a = this.horiz,
          ...
          f = h.x || 0,
          p = h.y || 0,
          y = this.chart.renderer.fontMetrics(
          ...
          b =
            (a ? c + this.height : b) +
            (a ? 1 : -1) * (m ? -1 : 1) * this.axisTitleMargin +
            (2 === this.side ? y : 0);
        return {
      ...
      renderTick: function(a, b) {
        ...
        if (!c || (a >= this.min && a <= this.max))
          e[a] || (e[a] = new I(this, a)),
            k && e[a].isNew && e[a].render(b, !0, 0.1),
            e[a].render(b);
      },
      render: function() {
        var a = this,
        ...
        if (a.hasData() || d)
          a.minorTickInterval &&
            ...
            v.length &&
              ...
              g &&
                (0 === a.min || a.single) &&
                (p[-1] || (p[-1] = new I(a, -1, null, !0)), p[-1].render(-1))),
            z &&
              b(v, function(b, e) {
            ...
            a._addedPlotLB ||
              (b((e.plotLines || []).concat(e.plotBands || []), function(b) {
        ...
        b([p, y, t], function(a) {
          ...
          for (b in a)
            a[b].isActive ||
              (a[b].render(b, !1, 0), (a[b].isActive = !1), h.push(b));
          K(function() {
            for (e = h.length; e--; )
              a[h[e]] &&
                !a[h[e]].isActive &&
                (a[h[e]].destroy(), delete a[h[e]]);
          }, a !== t && c.hasRendered && k ? k : 0);
        });
        E &&
          (E[E.isPlaced ? "animate" : "attr"]({
      ...
      drawCrosshair: function(a, b) {
        ...
        this.crosshair && !1 !== (l(b) || !h)
          ? (h
              ? l(b) && (k = this.isXAxis ? b.plotX : this.len - b.plotY)
              : (k =
                  a &&
                  (this.horiz
                    ? a.chartX - this.pos
            ...
            l(k) &&
              (c =
                this.getPlotLinePath(
                  b && (this.isXAxis ? b.x : w(b.stackY, b.y)),
                  null,
                  null,
                  null,
                  k
  ...
  (function(a) {
    ...
    B.prototype.getTimeTicks = function(a, q, t, m) {
      ...
      if (r(q)) {
        e[A.hcSetMilliseconds](
          F >= b.second ? 0 : w * Math.floor(e.getMilliseconds() / w)
        );
        if (F >= b.second)
          e[A.hcSetSeconds](
            F >= b.minute ? 0 : w * Math.floor(e.getSeconds() / w)
          );
        if (F >= b.minute)
          e[A.hcSetMinutes](
            F >= b.hour ? 0 : w * Math.floor(e[A.hcGetMinutes]() / w)
          );
        if (F >= b.hour)
          e[A.hcSetHours](
            F >= b.day ? 0 : w * Math.floor(e[A.hcGetHours]() / w)
          );
        if (F >= b.day)
          e[A.hcSetDate](
            F >= b.month ? 1 : w * Math.floor(e[A.hcGetDate]() / w)
          );
        F >= b.month &&
          (e[A.hcSetMonth](
            F >= b.year ? 0 : w * Math.floor(e[A.hcGetMonth]() / w)
          ),
          (z = e[A.hcGetFullYear]()));
        if (F >= b.year) e[A.hcSetFullYear](z - (z % w));
        if (F === b.week)
          e[A.hcSetDate](e[A.hcGetDate]() - e[A.hcGetDay]() + d(m, 1));
        z = e[A.hcGetFullYear]();
        m = e[A.hcGetMonth]();
        var y = e[A.hcGetDate](),
          J = e[A.hcGetHours]();
    ...
    B.prototype.normalizeTimeTickInterval = function(a, d) {
      ...
      for (
        ...
        (m = b[d[0]]),
        (c = d[1]),
        f[n + 1] && a <= (m * c[c.length - 1] + b[f[n + 1][0]]) / 2);
        n++
      );
  ...
  (function(a) {
    ...
    B.prototype.getLogTickPositions = function(a, f, u, l) {
      ...
      if (0.5 <= a)
        (a = Math.round(a)), (C = this.getLinearTickPositions(a, f, u));
      else if (0.08 <= a)
        for (
          var d = Math.floor(f),
            t,
          ...
          for (m = g.length, t = 0; t < m && !E; t++)
            (c = p(b(d) * g[t])),
              c > f && (!l || n <= u) && void 0 !== n && C.push(n),
              n > u && (E = !0),
              (n = c);
      else
        (f = b(f)),
          (u = b(u)),
          (a = g[l ? "minorTickInterval" : "tickInterval"]),
          (a = r(
            "auto" === a ? null : a,
            this._minorAutoInterval,
            ((g.tickPixelInterval / (l ? 5 : 1)) * (u - f)) /
              ((l ? d / this.tickPositions.length : d) || 1)
          )),
          (a = G(a, null, A(a))),
          (C = H(this.getLinearTickPositions(a, f, u), p)),
  ...
  (function(a) {
    ...
    a.Tooltip.prototype = {
      ...
      move: function(a, d, f, t) {
        var b = this,
          ...
          n =
            ...
            !b.isHidden &&
            (1 < Math.abs(a - c.x) || 1 < Math.abs(d - c.y)),
      ...
      getAnchor: function(a, d) {
        ...
        this.followPointer &&
          d &&
          (void 0 === d.chartX && (d = f.pointer.normalize(d)),
      ...
      getPosition: function(a, d, f) {
        var b = this.chart,
          ...
          w = function(a, b, e, h) {
            ...
            h < m || h > b - m
              ? (k = !1)
              : (c[a] = h < e / 2 ? 1 : h > b - e / 2 ? b - e - 2 : h - e / 2);
            return k;
          },
          h = function(a) {
            var b = z;
          ...
          : ((f = this.getLabel()),
            this.isHidden &&
              f
                ...
                .show(),
            this.split
              ? this.renderSplit(p, b.hoverPoints)
              : (f.attr({
                ...
                f
                  ...
                  .addClass(
                    "highcharts-color-" + u(a.colorIndex, e.colorIndex)
                  ),
                f.attr({
        ...
        A(b.slice(0, d.length + 1), function(a, b) {
          ...
          b.isHeader
            ? ((z = a.height),
              (y = Math.max(
                0,
                Math.min(b.plotX + m.plotLeft - y / 2, m.chartWidth - y)
              )))
            : (y = b.plotX + m.plotLeft - u(g.distance, 16) - y);
          0 > y && (n = !1);
          a =
            (b.series && b.series.yAxis && b.series.yAxis.pos) + (b.plotY || 0);
          a -= m.plotTop;
          p.push({
      ...
      getDateFormat: function(a, f, g, t) {
        ...
        for (n in d) {
          ...
          if (p[n] && b.substr(p[n]) !== "01-01 00:00:00.000".substr(p[n]))
            break;
          "week" !== n && (z = n);
        }
        n && (c = t[n]);
      ...
      getXDateFormat: function(a, d, f) {
        ...
        return (
          (b ? this.getDateFormat(b, a.x, f.options.startOfWeek, d) : d.day) ||
          d.year
        );
      },
    ...
    a.Pointer.prototype = {
      ...
      normalize: function(a, b) {
        ...
        void 0 === n.pageX
          ...
          : ((c = n.pageX - b.left), (b = n.pageY - b.top));
        return l(a, {
          chartX: Math.round(c),
          chartY: Math.round(b)
        });
      ...
      runPointActions: function(c) {
        ...
        w && (e ? w.noSharedTooltip : w.directTouch) && t
          ? (q = [t])
          : (e || !w || w.options.stickyTracking || (m = [w]),
            u(m, function(a) {
              ...
              a.visible &&
                ...
                (r = a.searchPoint(c, !y && 1 === a.kdDimensions)) &&
                r.series &&
                q.push(r);
            }),
            q.sort(function(a, b) {
        ...
        if (e)
          for (h = q.length; h--; )
            (q[h].x !== q[0].x || q[h].series.noSharedTooltip) &&
              q.splice(h, 1);
        if (q[0] && (q[0] !== this.prevKDPoint || (p && p.isHidden))) {
          ...
          } else if ((p && p.refresh(q[0], c), !w || !w.directTouch))
            q[0].onMouseOver(c);
          this.prevKDPoint = q[0];
          g = !1;
        }
        g &&
          ((m = w && w.tooltipOptions.followPointer),
          p &&
            m &&
            !p.isHidden &&
            ((m = p.getAnchor([{}], c)),
        ...
        this.unDocMouseMove ||
          (this.unDocMouseMove = B(f, "mousemove", function(b) {
            if (H[a.hoverChartIndex])
              H[a.hoverChartIndex].pointer.onDocumentMouseMove(b);
          }));
      ...
      drag: function(a) {
        ...
        (q && q.touch) ||
          ...
          (this.hasDragged = Math.sqrt(
            Math.pow(k - d, 2) + Math.pow(l - e, 2)
          )),
          10 < this.hasDragged &&
            ((t = b.isInsidePlot(k - p, l - h)),
      ...
      destroy: function() {
        ...
        a.chartCount ||
          (p(f, "mouseup", this.onDocumentMouseUp),
          p(f, "touchend", this.onDocumentTouchEnd));
  ...
  (function(a) {
    ...
    H(a.Pointer.prototype, {
      ...
      pinchTranslateDirection: function(a, g, l, q, d, b, p, r) {
        ...
        g < h.min
          ? ((g = h.min), (D = !0))
          : g + e > h.max && ((g = h.max - e), (D = !0));
        D
          ? ((u -= 0.8 * (u - p[m][0])), y || (k -= 0.8 * (k - p[m][1])), l())
          : (p[m] = [u, k]);
        w || ((b[m] = x - z), (b[E] = e));
        b = w ? 1 / F : F;
        d[E] = e;
      ...
      pinch: function(a) {
        var f = this,
          ...
          c =
            1 === b &&
            ((f.inClass(a.target, "highcharts-tracker") && l.runTrackerClick) ||
              f.runChartClick),
          n = {};
        1 < b && (f.initiated = !0);
        ...
        "touchstart" === a.type
          ? (A(d, function(a, b) {
            ...
            (f.res = !0))
          : f.followTouchMove && 1 === b
            ? this.runPointActions(f.normalize(a))
            : q.length &&
              (t ||
                (f.selectionMarker = t = H(
                  {
                    destroy: r,
                    touch: !0
                  },
      ...
      touch: function(f, r) {
        ...
        1 === f.touches.length
          ? ((f = this.normalize(f)),
            (d = l.isInsidePlot(f.chartX - l.plotLeft, f.chartY - l.plotTop)) &&
            !l.openMenu
              ? (r && this.runPointActions(f),
                "touchmove" === f.type &&
                  ((r = this.pinchDown),
                  (q = r[0]
                    ? 4 <=
                      Math.sqrt(
                        Math.pow(r[0].chartX - f.chartX, 2) +
                          Math.pow(r[0].chartY - f.chartY, 2)
                      )
                    : !1)),
                g(q, !0) && this.pinch(f))
              : r && this.reset())
  ...
  (function(a) {
    ...
    B.prototype = {
      ...
      colorizeItem: function(a, b) {
        ...
        if (e) {
          if (g && e.isMarker && ((h = a.pointAttribs()), !b))
            for (y in h) h[y] = f;
          e.attr(h);
        }
      },
      positionItem: function(a) {
        ...
        (a = a.legendGroup) &&
          a.element &&
          a.translate(b ? f : this.legendWidth - f - 2 * d - 4, m);
        e && ((e.x = f), (e.y = m));
      },
      destroyItem: function(a) {
        var b = a.checkbox;
        g(["legendItem", "legendLine", "legendSymbol", "legendGroup"], function(
          b
        ) {
          a[b] && (a[b] = a[b].destroy());
        });
      ...
      renderItem: function(a) {
        ...
        C ||
          ...
          (a.legendItem = C = f
            .text("", J ? e + g : -g, this.baseline || 0, v)
            .css(q(a.visible ? l : t))
            .attr({
              align: J ? "left" : "right",
              zIndex: 2
          ...
          this.baseline ||
            ((l = l.fontSize),
            (this.fontMetrics = f.fontMetrics(l, C)),
            (this.baseline = this.fontMetrics.f + 3 + k),
            C.attr("y", this.baseline)),
          (this.symbolHeight = m.symbolHeight || this.fontMetrics.f),
          A.drawLegendSymbol(this, a),
          this.setItemEvents && this.setItemEvents(a, C, v),
        ...
        e = a.checkboxOffset =
          m.itemWidth ||
          a.legendItemWidth ||
          e + g + f.width + y + (B ? 20 : 0);
        this.itemHeight = g = Math.round(a.legendItemHeight || f.height);
        p &&
          this.itemX - u + e > (r || b.chartWidth - 2 * h - u - m.x) &&
          ((this.itemX = u),
          (this.itemY += k + this.lastLineHeight + I),
      ...
      getAllItems: function() {
        ...
        g(this.chart.series, function(b) {
          var c = b && b.options;
          b &&
            d(c.showInLegend, r(c.linkedTo) ? !1 : void 0, !0) &&
            (a = a.concat(
      ...
      adjustMargins: function(a, b) {
        var c = this.chart,
          f = this.options,
          m =
            f.align.charAt(0) + f.verticalAlign.charAt(0) + f.layout.charAt(0);
        f.floating ||
          g(
            ...
            function(e, n) {
              e.test(m) &&
                ...
                (c[l[n]] = Math.max(
                  c[l[n]],
                  c.legend[(n + 1) % 2 ? "legendHeight" : "legendWidth"] +
                    [1, -1, -1, 1][n] * f[n % 2 ? "x" : "y"] +
                    d(f.margin, 12) +
                    b[n]
                ));
          ...
          C = function(a) {
            ...
            b.contentGroup.div &&
              (b.contentGroup.div.style.clip = a
                ? "rect(" + I + "px,9999px," + (I + a) + "px,0)"
                : "auto");
          };
        "horizontal" !== p.layout ||
          "middle" === p.verticalAlign ||
          p.floating ||
          (f /= 2);
        e && (f = Math.min(f, e));
        u.length = 0;
        a > f && !1 !== t.enabled
          ? ((this.clipHeight = q = Math.max(f - 20 - this.titleHeight - I, 0)),
            ...
            g(D, function(a, b) {
              ...
              var e = u.length;
              if (!e || (c - u[e - 1] > q && (k || c) !== u[e - 1]))
                u.push(k || c), e++;
              b === D.length - 1 && c + a - u[e - 1] > q && u.push(c);
              c !== k && (k = c);
            }),
            l ||
              ((l = b.clipRect = m.clipRect(0, I, 9999, 0)),
    ...
    a.LegendSymbolMixin = {
      drawRectangle: function(a, b) {
        ...
        b.legendSymbol = this.chart.renderer
          .rect(
            f ? (a.symbolWidth - c) / 2 : 0,
            a.baseline - c + 1,
            f ? c : a.symbolWidth,
            c,
            d(a.options.symbolRadius, c / 2)
          )
      ...
      drawLineMarker: function(a) {
        ...
        f &&
          ...
          0 === this.symbol.indexOf("url") &&
            ...
            (b = 0)),
          (this.legendSymbol = f = g
            .symbol(this.symbol, m / 2 - b, a - b, 2 * b, 2 * b, f)
            .addClass("highcharts-point")
            .add(l)),
          (f.isMarker = !0));
      }
    };
    (/Trident\/7\.0/.test(C.navigator.userAgent) || u) &&
      t(B.prototype, "positionItem", function(a, b) {
        var c = this,
          d = function() {
  ...
  (function(a) {
    ...
    O.prototype = {
      ...
      redraw: function(b) {
        ...
        p(e, function(a) {
          a.isDirty &&
            ...
            (a.updateTotals && a.updateTotals(), (k = !0));
      ...
      getContainer: function() {
        ...
        this.renderer = new (a[h.renderer] || S)(
          b,
          d,
          k,
          null,
      ...
      getMargins: function(a) {
        ...
        h &&
          ...
          (this.plotTop = Math.max(
            this.plotTop,
            h + this.options.title.margin + c[0]
          ));
      ...
      reflow: function(a) {
        ...
        if (!k && !e.isPrinting && f && h && (d === N || d === r)) {
          if (f !== e.containerWidth || h !== e.containerHeight)
      ...
      setChartSize: function(a) {
        ...
        this.plotHeight = g = Math.max(
          0,
          Math.round(h - n - this.marginBottom)
        );
        ...
        this.clipBox = {
          ...
          height: Math.max(
            0,
            Math.floor(this.plotSizeY - Math.max(e, f[2]) / 2 - c)
          )
        };
        a ||
      ...
      drawChartBox: function() {
        ...
        if (f || h["stroke-width"])
          (n.stroke = a.borderColor), (n["stroke-width"] = f);
        ...
        y &&
          (m
            ? m.animate(x)
            : (this.plotBGImage = b.image(y, l, q, t, w).add()));
        r
          ? r.animate({
              width: z.width,
              height: z.height
      ...
      isReadyToRender: function() {
        var a = this;
        return D || N != N.top || "complete" === r.readyState
          ? !0
  ...
  (function(a) {
    ...
    B.prototype = {
      ...
      applyOptions: function(a, b) {
        ...
        void 0 === this.x &&
          d &&
          (this.x = void 0 === b ? d.autoIncrement(this) : b);
        return this;
      },
    ...
    a.Series = a.seriesType(
      ...
      },
      {
        ...
        setOptions: function(a) {
          ...
          this.userOptions = a;
          c = n(h, c.series, a);
          this.tooltipOptions = n(
            f.tooltip,
            f.plotOptions[this.type].tooltip,
            b.tooltip,
            ...
            if (x && g > x) {
              ...
              for (d = 0; d < g; d++)
                void 0 !== b[d] &&
                  ...
                  h.pointClass.prototype.applyOptions.apply(l, [b[d]]),
                  h.updateParallelArrays(l, d));
            c(z[0]) && a.error(14, !0);
            h.data = [];
        ...
        processData: function(b) {
          ...
          var p = this.getExtremesFromAll || g.getExtremesFromAll,
            ...
            t,
            w;
          if (l && !this.isDirty && !n.isDirty && !this.yAxis.isDirty && !b)
            return !1;
          n && ((b = n.getExtremes()), (t = b.min), (w = b.max));
          if (l && this.sorted && !p && (!m || h > m || this.forceCrop))
            if (c[h - 1] < t || c[0] > w) (c = []), (e = []);
            else if (c[0] < t || c[h - 1] > w)
              (d = this.cropData(this.xData, this.yData, t, w)),
                (c = d.xData),
                (e = d.yData),
                (d = d.start),
                (k = !0);
          for (m = c.length || 1; --m; )
            (h = q ? g(c[m]) - g(c[m - 1]) : c[m] - c[m - 1]),
              0 < h && (void 0 === f || h < f)
                ? (f = h)
                : 0 > h && this.requireSorting && a.error(15);
          this.cropped = k;
          this.cropStart = d;
        ...
        generatePoints: function() {
          ...
          for (t = 0; t < n; t++)
            (g = m + t),
              p
                ? ((l = new k().init(this, [d[t]].concat(e(f[t])))),
                  (l.dataGroup = this.groupMap[t]))
                : (l = b[g]) ||
                  void 0 === a[g] ||
                  (b[g] = l = new k().init(this, a[g], d[t])),
              (l.index = g),
              (q[t] = l);
          if (b && (n !== (c = b.length) || p))
            for (t = 0; t < c; t++)
        ...
        getExtremes: function(a) {
          ...
          for (q = 0; q < e; q++)
            if (
              ((p = c[q]),
              (l = a[q]),
              (g = (m(l, !0) || t(l)) && (!b.isLog || l.length || 0 < l)),
              (p =
        ...
        translate: function() {
          ...
          for (a = 0; a < f; a++) {
            ...
            var H =
                b &&
                d.stacks[
                  (this.negStacks && B < (t ? 0 : q) ? "-" : "") + this.stackKey
                ],
              G;
            ...
            C.plotX = w = r(
              Math.min(
                Math.max(
                  -1e5,
                  c.translate(A, 0, 0, 0, 1, g, "flags" === this.type)
                ),
                1e5
              )
            );
            b &&
              ...
              H &&
              H[A] &&
              ((F = this.getStackIndicator(F, A, this.index)),
              (G = H[A]),
              (B = G.points[F.key]),
              (x = B[0]),
              (B = B[1]),
              x === t && F.key === H[A].base && (x = E(q, d.min)),
              d.isLog && 0 >= x && (x = null),
              (C.total = C.stackTotal = G.total),
              (C.percentage = G.total && (C.y / G.total) * 100),
              (C.stackY = B),
            ...
            C.plotY = x =
              "number" === typeof B && Infinity !== B
                ? Math.min(Math.max(-1e5, d.translate(B, 0, 1, 0, 1)), 1e5)
                : void 0;
            C.isInside =
              void 0 !== x && 0 <= x && x <= d.len && 0 <= w && w <= c.len;
          ...
          if (!1 !== f.enabled || this._hasPointMarkers)
            for (e = 0; e < a.length; e++)
              (d = a[e]),
                ...
                (n = d.marker || {}),
                (g = !!d.marker),
                (p = (t && void 0 === n.enabled) || n.enabled),
                (l = d.isInside),
                p && m(c) && null !== d.y
                  ? ((c = E(n.symbol, this.symbol)),
                    (d.hasImage = 0 === c.indexOf("url")),
                    (p = this.markerAttribs(d, d.selected && "select")),
                    k
                      ? k[l ? "show" : "hide"](!0).animate(p)
                      : l &&
                        (0 < p.width || d.hasImage) &&
                        (d.graphic = k = b.renderer
                          .symbol(c, p.x, p.y, p.width, p.height, g ? n : f)
                          .add(q)),
                    k && k.attr(this.pointAttribs(d, d.selected && "select")),
                    k && k.addClass(d.getClassName(), !0))
        ...
        pointAttribs: function(a, b) {
          ...
          b &&
            ...
            (e = E(
              b.lineWidth,
              c.lineWidth,
              e + E(b.lineWidthPlus, c.lineWidthPlus, 0)
            )),
        ...
        destroy: function() {
          ...
          for (n in a)
            a[n] instanceof x &&
              !a[n].survive &&
              ((e = c && "group" === n ? "hide" : "destroy"), a[n][e]());
        ...
        applyZones: function() {
          ...
          e.length &&
            ...
            q(e, function(e, h) {
              ...
              f = Math.min(
                Math.max(Math.round(t.toPixels(E(e.value, w.max), !0)), 0),
                l
              );
  ...
  (function(a) {
      ...
      setOffset: function(a, d) {
        ...
        if ((d = this.label))
          d.align(this.alignOptions, null, g),
            (g = d.alignAttr),
            d[
              !1 === this.options.crop || f.isInsidePlot(g.x, g.y)
                ? "show"
                : "hide"
            ](!0);
      }
    ...
    A.prototype.resetStacks = function() {
      ...
      if (!this.isXAxis)
        for (d in a)
          for (b in a[d])
            a[d][b].touched < this.stacksTouched
              ? (a[d][b].destroy(), delete a[d][b])
              : ((a[d][b].total = null), (a[d][b].cum = null));
    };
    ...
    a.prototype.setStackedPoints = function() {
      if (
        ...
        for (K = 0; K < f; K++)
          (I = a[K]),
            (k = d[K]),
            (w = this.getStackIndicator(w, I, this.index)),
            (A = w.key),
            (y = (h = z && k < (m ? 0 : t)) ? u : n),
            x[y] || (x[y] = {}),
            x[y][I] ||
              (F[y] && F[y][I]
                ? ((x[y][I] = F[y][I]), (x[y][I].total = null))
                : (x[y][I] = new B(e, e.options.stackLabels, h, I, c))),
            (y = x[y][I]),
            null !== k &&
              ((y.points[A] = y.points[this.index] = [l(y.cum, m)]),
              r(y.cum) || (y.base = A),
              (y.touched = e.stacksTouched),
              0 < w.index &&
                !1 === this.singleStacks &&
                (y.points[A][0] = y.points[this.index + "," + I + ",0"][0])),
            "percent" === g
              ? ((h = h ? n : u),
                z && x[h] && x[h][I]
                  ? ((h = x[h][I]),
                    (y.total = h.total =
                      Math.max(h.total, y.total) + Math.abs(k) || 0))
                  : (y.total = G(y.total + (Math.abs(k) || 0))))
              : (y.total = G(y.total + (k || 0))),
            (y.cum = l(y.cum, m) + (k || 0)),
            null !== k && (y.points[A].push(y.cum), (b[K] = y.cum));
    ...
    a.prototype.setPercentStacks = function() {
      ...
      f([d, "-" + d], function(d) {
        for (var f = g.length, c, n; f--; )
          if (
            ((c = g[f]),
            (l = a.getStackIndicator(l, c, a.index, d)),
            (c = (n = b[d] && b[d][c]) && n.points[l.key]))
          )
            (n = n.total ? 100 / n.total : 0),
              (c[0] = G(c[0] * n)),
              (c[1] = G(c[1] * n)),
              (a.stackedYData[f] = c[1]);
      });
    };
  ...
  (function(a) {
    ...
    l(a.Chart.prototype, {
      ...
      update: function(a, c) {
          ...
          function(b) {
            a[b] &&
              f(
                z(a[b]),
                function(a, c) {
                  (c = (g(a.id) && this.get(a.id)) || this[b][c]) &&
                    c.coll === b &&
                    c.update(a, !1);
                },
                this
        ...
        e = h && h.width;
        h = h && h.height;
        (b(e) && e !== this.chartWidth) || (b(h) && h !== this.chartHeight)
          ? this.setSize(e, h)
          : t(c, !0) && this.redraw();
      },
      ...
      },
      {
          ...
          var f = r.prototype.getGraphPath,
            ...
            x = function(b, e, f) {
              ...
              var p,
                ...
                h = !0;
              f || g
                ? ((p = (g ? b[0] : b[1]) + f), (l = b[0] + f), (h = !!g))
                : !q && a[e] && a[e].isNull && (p = l = E);
              void 0 !== p &&
                (t.push({
                  plotX: c,
        ...
        drawGraph: function() {
          ...
          A(this.zones, function(d, b) {
            q.push([
              "zone-area-" + b,
              "highcharts-area highcharts-zone-area-" + b + " " + d.className,
              d.color || a.color,
              ...
              : ((f = a[b] = a.chart.renderer
                  ...
                  .attr({
                    fill: G(
                      d[3],
                      B(d[2])
                        .setOpacity(G(l.fillOpacity, 0.75))
                        .get()
                    ),
                    zIndex: 0
                  })
      ...
      {},
      {
        getPointSpline: function(a, H, G) {
          ...
          if (
            ...
            d += b;
            l > a && l > g
              ? ((l = Math.max(a, g)), (d = 2 * g - l))
              : l < a && l < g && ((l = Math.min(a, g)), (d = 2 * g - l));
            d > G && d > g
              ? ((d = Math.max(G, g)), (l = 2 * g - d))
              : d < G && d < g && ((d = Math.min(G, g)), (l = 2 * g - d));
            H.rightContX = q;
            H.rightContY = d;
          }
          H = [
            "C",
            B(f.rightContX, f.plotX),
            B(f.rightContY, f.plotY),
            B(u, r),
            B(l, g),
            r,
            g
      ...
      },
      {
        ...
        getColumnMetrics: function() {
          ...
          var q = Math.min(
            ...
            e = (q - 2 * r) / (n || 1),
            b = Math.min(
              b.maxPointWidth || g.len,
              f(b.pointWidth, e * (1 - 2 * b.pointPadding))
            );
          a.columnMetrics = {
            width: b,
            offset:
              (e - b) / 2 +
              (r + ((a.columnIndex || 0) + (t ? 1 : 0)) * e - q / 2) *
                (t ? -1 : 1)
          };
        ...
        translate: function() {
          ...
          H(a.points, function(d) {
            ...
            Math.abs(x) < c &&
              c &&
              ((x = c),
              (z = (!t.reversed && !d.negative) || (t.reversed && d.negative)),
              (p = Math.abs(p - m) > c ? g - c : m - (z ? c : 0)));
            d.barX = h;
            d.pointWidth = q;
            d.tooltipPos = b.inverted
              ? [t.len + t.pos - b.plotLeft - n, a.xAxis.len - h - l / 2, x]
              : [h + l / 2, n + t.pos - b.plotTop, x];
            d.shapeType = "rect";
            d.shapeArgs = a.crispCol.apply(
              a,
              d.isNull ? [d.plotX, t.len / 2, 0, 0] : [h, p, l, x]
            );
          });
        },
        getSymbol: a.noop,
        ...
        pointAttribs: function(a, b) {
          ...
          a &&
            this.zones.length &&
            (c =
              ((c = a.getZone()) && c.color) || a.options.color || this.color);
          b &&
            ((a = d.states[b]),
            (b = a.brightness),
            (c =
          ...
          H(a.points, function(c) {
            ...
            if (r(c.plotY) && null !== c.y) {
              ...
              if (d) d[b.pointCount < t ? "animate" : "attr"](g(m));
                ...
                c.graphic = d = l[c.shapeType](m)
                  .attr({
                    class: c.getClassName()
                  })
                  .add(c.group || a.group);
              d.attr(a.pointAttribs(c, c.selected && "select")).shadow(
                f.shadow,
                null,
          ...
          q &&
            (a
              ? ((m.scaleY = 0.001),
                ...
                g ? (m.translateX = a - d.len) : (m.translateY = a),
                b.group.attr(m))
              : ((m[g ? "translateX" : "translateY"] = d.pos),
                b.group.animate(
                  m,
                  G(B(b.options.animation), {
                    step: function(a, d) {
                      b.group.attr({
    ...
    q(
      ...
      },
      {
        ...
        updateTotals: function() {
          ...
          for (a = 0; a < g; a++)
            (m = f[a]),
              (m.percentage = 0 < d && (m.visible || !c) ? (m.y / d) * 100 : 0),
              (m.total = d);
        },
        generatePoints: function() {
        ...
        translate: function(a) {
          ...
          var b = 0,
            ...
            q =
              (this.endAngleRad =
                (Math.PI / 180) * (f(d.endAngle, q + 360) - 90)) - e,
            r = this.points,
          ...
          for (w = 0; w < h; w++) {
            ...
            c = (Math.cos(l) * a[2]) / 2;
            n = (Math.sin(l) * a[2]) / 2;
            y.tooltipPos = [a[0] + 0.7 * c, a[1] + 0.7 * n];
      ...
      },
      {
        ...
        setVisible: function(a, d) {
          ...
          a !== b.visible &&
            ...
            (g.options.data[r(b, g.data)] = b.options),
            H(["graphic", "dataLabel", "connector", "shadowGroup"], function(
              c
            ) {
              if (b[c]) b[c][a ? "show" : "hide"](!0);
            }),
            b.legendItem && m.legend.colorizeItem(b, a),
  ...
  (function(a) {
    ...
    b.prototype.drawDataLabels = function() {
      ...
      if (c.enabled || a._hasPointLabels)
        a.dlProcessOptions && a.dlProcessOptions(c),
          (r = a.plotGroup(
            "dataLabelsGroup",
            "data-labels",
            w && !e ? "hidden" : "visible",
          ...
          G(d, function(e) {
            ...
            if ((d = q(f && f.enabled, l.enabled) && null !== e.y))
              for (k in ((c = u(l, f)),
              (n = e.getLabelConfig()),
              (p = c.format ? g(c.format, n) : c.formatter.call(n, c)),
              (x = c.style),
              (t = c.rotation),
              (x.color = q(c.color, x.color, a.color, "#000000")),
              "contrast" === x.color &&
                (x.color =
                  c.inside || 0 > c.distance || b.stacking
                    ? h.getContrast(e.color || a.color)
                    : "#000000"),
              b.cursor && (x.cursor = b.cursor),
              (n = {
            ...
            !m || (d && H(p))
              ? d &&
                ...
                m.attr(n),
                m.css(x).shadow(c.shadow),
                m.added || m.add(r),
                a.alignDataLabel(e, m, c, null, w))
              : ((e.dataLabel = m.destroy()), z && (e.connector = z.destroy()));
          });
    };
    b.prototype.alignDataLabel = function(a, b, c, d, f) {
      var g = this.chart,
        ...
        u =
          this.visible &&
          (a.series.forceDL ||
            g.isInsidePlot(m, Math.round(n), e) ||
            (d && g.isInsidePlot(m, e ? d.x + 1 : d.y + d.height - 1, e))),
        E = "justify" === q(c.overflow, "justify");
      u &&
        ((h = c.style.fontSize),
        (h = g.renderer.fontMetrics(h, b).b),
        (d = r(
          {
            x: e ? g.plotWidth - n : m,
        ...
        p
          ? ((E = !1),
            ...
            "left" === t
              ? (e.y -= m ? l.height : 0)
              : "center" === t
                ? ((e.x -= l.width / 2), (e.y -= l.height / 2))
                : "right" === t &&
                  ((e.x -= l.width), (e.y -= m ? 0 : l.height)))
          : (b.align(c, null, d), (e = b.alignAttr)),
        E
          ? this.justifyDataLabel(b, c, e, l, d, f)
          : q(c.crop, !0) &&
            (u =
              g.isInsidePlot(e.x, e.y) &&
              g.isInsidePlot(e.x + l.width, e.y + l.height)),
        c.shape &&
          !p &&
          b.attr({
            anchorX: a.plotX,
    ...
    b.prototype.justifyDataLabel = function(a, b, c, d, f, g) {
      ...
      l = c.x + d.width - p;
      l > e.plotWidth &&
        ("left" === m ? (b.align = "right") : (b.x = e.plotWidth - l),
        (h = !0));
      l = c.y + p;
      0 > l &&
        ("bottom" === n ? (b.verticalAlign = "top") : (b.y = -l), (h = !0));
      l = c.y + d.height - p;
      l > e.plotHeight &&
        ("top" === n ? (b.verticalAlign = "bottom") : (b.y = e.plotHeight - l),
        (h = !0));
    ...
    p.pie &&
      ((p.pie.prototype.drawDataLabels = function() {
        var d = this,
          ...
          R = [0, 0, 0, 0];
        d.visible &&
          (p.enabled || d._hasPointLabels) &&
          (b.prototype.drawDataLabels.apply(d),
          G(g, function(a) {
            a.dataLabel &&
              a.visible &&
              (S[a.half].push(a), (a.dataLabel._pos = null));
          }),
          G(S, function(b, e) {
            var g,
              m,
            ...
            if (n)
              for (
                d.sortByAngle(b, e - 0.5),
                  0 < h &&
                    ((g = Math.max(0, B - C - h)),
                    (m = Math.min(B + C + h, l.plotHeight)),
                    (q = f(b, function(a) {
                      if (a.dataLabel)
                        return (
                ...
                (c = b[Q]),
                  (L = c.labelPos),
                  (k = c.dataLabel),
                  (M = !1 === c.visible ? "hidden" : "inherit"),
                  (t = L[1]),
                  q
                    ? void 0 === q[Q].pos
                      ? (M = "hidden")
                      : ((N = q[Q].size), (v = g + q[Q].pos))
                    : (v = t),
                  (O = p.justify
                    ? y[0] + (e ? -1 : 1) * (C + h)
                    : d.getX(v < g + 2 || v > m - 2 ? t : v, e)),
                  (k._attr = {
                    visibility: M,
                    align: L[6]
                  }),
                  ...
                  null === d.options.size &&
                    ((D = k.width),
                    O - D < r
                      ? (R[3] = Math.max(Math.round(D - O + r), R[3]))
                      : O + D > u - r &&
                        (R[1] = Math.max(Math.round(O + D - u + r), R[1])),
                    0 > v - N / 2
                      ? (R[0] = Math.max(Math.round(-v + N / 2), R[0]))
                      : v + N / 2 > F &&
                        (R[2] = Math.max(Math.round(v + N / 2 - F), R[2])));
          }),
          0 === A(R) || this.verifyDataLabelOverflow(R)) &&
      ...
      (p.pie.prototype.connectorPath = function(a) {
        var b = a.x,
          c = a.y;
        return q(this.options.dataLabels.softConnector, !0)
          ? [
              "M",
              b + ("left" === a[6] ? 5 : -5),
              c,
      ...
      (p.pie.prototype.alignDataLabel = l),
      (p.pie.prototype.verifyDataLabelOverflow = function(a) {
        var b = this.center,
          ...
          e;
        null !== f[0]
          ? (l = Math.max(b[2] - Math.max(a[1], a[3]), g))
          : ((l = Math.max(b[2] - a[1] - a[3], g)),
            (b[0] += (a[3] - a[1]) / 2));
        null !== f[1]
          ? (l = Math.max(Math.min(l, b[2] - Math.max(a[0], a[2])), g))
          : ((l = Math.max(Math.min(l, b[2] - a[0] - a[2]), g)),
            (b[1] += (a[0] - a[2]) / 2));
        l < b[2]
          ? ((b[2] = l),
    ...
    p.column &&
      (p.column.prototype.alignDataLabel = function(a, d, c, f, g) {
      ...
      for (r = 0; r < g; r++)
        for (l = a[r], f = r + 1; f < g; ++f)
          if (
            ...
            (l.labelrank < q.labelrank ? l : q).newOpacity = 0;
      A(a, function(a) {
        var b, c;
        a &&
          ((c = a.newOpacity),
  ...
  (function(a) {
    ...
    a = a.TrackerMixin = {
      ...
      drawTrackerGraph: function() {
        var a = this,
          ...
          t = "rgba(192,192,192," + (E ? 0.0001 : 0.002) + ")";
        if (g && !c)
          for (k = g + 1; k--; )
            "M" === d[k] && d.splice(k + 1, 0, d[k + 1] - n, d[k + 2], "L"),
              ((k && "M" === d[k]) || k === g) &&
                d.splice(k, 0, "L", d[k - 2] + n, d[k - 1]);
        p
          ? p.attr({
              d: d
            })
          : a.graph &&
            ((a.tracker = m
              ...
              .add(a.group)),
            f([a.tracker, a.markerGroup], function(a) {
        ...
        !a || a.resetSelection
          ...
          : f(a.xAxis.concat(a.yAxis), function(a) {
              ...
              d[b.isXAxis ? "zoomX" : "zoomY"] &&
                ((c = b.zoom(a.min, a.max)), b.displayBtn && (g = !0));
            });
        l = this.resetZoomButton;
        g && !l
          ? this.showResetZoom()
          : !g && b(l) && (this.resetZoomButton = l.destroy());
        c &&
          this.redraw(
            t(
      ...
      select: function(a, b) {
        ...
        c.firePointEvent(
          ...
          function() {
            ...
            c.setState(a && "select");
            b ||
              f(g.getSelectedPoints(), function(a) {
                a.selected &&
                  a !== c &&
            ...
            this.state &&
              ...
              C &&
                this.graphic.animate(
                  C,
                  t(r.options.chart.animation, n.animation, l.animation)
                ),
              k && k.hide();
          else {
            if (a && n) {
              ...
              if (k)
                ...
                l &&
                  ((e.stateMarkerGraphic = k = r.renderer
                    .symbol(l, C.x, C.y, C.width, C.height)
                    .add(e.markerGroup)),
                  (k.currentSymbol = l));
              k && k.attr(e.pointAttribs(this, a));
            }
            k &&
              (k[a && r.isInsidePlot(c, d, r.inverted) ? "show" : "hide"](),
    ...
    u(c.prototype, {
      ...
      setState: function(a) {
        ...
        if (
          b.state !== a &&
          (f([b.group, b.markerGroup], function(c) {
            c &&
  ...
  (function(a) {
    ...
    B.prototype.matchResponsiveRule = function(f, g) {
      ...
      d =
        ...
        function() {
          return (
            this.chartWidth <= r(q.maxWidth, Number.MAX_VALUE) &&
            this.chartHeight <= r(q.maxHeight, Number.MAX_VALUE) &&
            this.chartWidth >= r(q.minWidth, 0) &&
            this.chartHeight >= r(q.minHeight, 0)
          );
        };
      ...
      !l[f._id] && d
        ? f.chartOptions &&
          ...
          this.update(f.chartOptions, g))
        : l[f._id] && !d && (this.update(l[f._id], g), delete l[f._id]);
    };
      ...
      function f(a, d, b, l) {
        ...
        for (p in a)
          if (!l && -1 < H(p, ["series", "xAxis", "yAxis"]))
            for (a[p] = g(a[p]), b[p] = [], q = 0; q < a[p].length; q++)
              (b[p][q] = {}), f(a[p][q], d[p][q], b[p][q], l + 1);
          else
            G(a[p])
              ? ((b[p] = {}), f(a[p], d[p] || {}, b[p], l + 1))
              : (b[p] = d[p] || null);
      }
      var l = {};
