$(document).ready(function() {
    ...
    return this.each(function() {
      ...
      this.response = function(json) {
        ...
        if (json.length) {
          ...
          for (i = 0; i < count; i++) {
            html +=
              '<li data-value="' + json[i]["type"] + "-" + json[i]["id"] + '">';
      ...
      $(this)
        ...
        .parent()
        .after(
          '<ul class="dropdown-menu" id="result-search" style="padding:2px 2px 2px 2px;"></ul>'
        );
      $(this)
        .parent()
        .parent()
  ...
  $("input:radio").each(function() {
    if (
      ...
      if (
        input_text.localeCompare(text_yes) == 1 &&
        input_text.localeCompare(text_no) == 1
      ) {
        return;
      }
      ...
      $("#" + input_name + "_1")
        ...
        .addClass(enable_class);
      $("#" + input_name + "_0")
        .removeClass("btn-default")
        .addClass(disable_class);
    }
  });
  ...
  $(document).on("click", ".btn-group label:not(.active)", function(e) {
    ...
    if (!disable_input.is(":checked")) {
      enable_input = $(
        'input[name="' + disable_input.attr("name") + '"]:checked'
      );
